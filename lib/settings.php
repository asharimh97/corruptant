<?php 
	...
	*/
	...
	$set['base_path'] = '/merdeka/' ;

	DEFINE('BASEPATH',$set['protocol'].$set['host'].$set['base_path']) ;

	DEFINE('ASSETS',$set['protocol'].$set['host'].$set['base_path'].'assets/') ;

	DEFINE('LIB',$set['protocol'].$set['host'].$set['base_path'].'lib/') ;

	DEFINE('ADMIN',$set['protocol'].$set['host'].$set['base_path'].'admin/') ;

	DEFINE('VIEW',$set['protocol'].$set['host'].$set['base_path'].'view/') ;
?>